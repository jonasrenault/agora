...
4. [Get credentials for a Desktop application](https://console.developers.google.com/auth/clients) and save the credentials as `credentials.json` into the `.credentials` folder.
